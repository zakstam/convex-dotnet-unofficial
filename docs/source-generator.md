...
The `Convex.FunctionGenerator` source generator reads your Convex backend's `api.d.ts` file (generated by Convex) and creates C# constants for function names. This provides:
...
`obj/Debug/generated/Convex.FunctionGenerator/ConvexFunctions.g.cs`
