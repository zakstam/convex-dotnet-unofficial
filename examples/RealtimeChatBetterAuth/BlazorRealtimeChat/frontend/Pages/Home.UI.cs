...
public partial class Home
{
    ...
    protected List<OnlineUserDto> GetMentionSuggestions()
    {
        ...
        return string.IsNullOrWhiteSpace(query)
            ? [.. State.OnlineUsers.Where(u => u.Username != State.Username)]
            : [.. State.OnlineUsers.Where(u => u.Username != State.Username && u.Username.StartsWith(query, StringComparison.OrdinalIgnoreCase))];
    }
