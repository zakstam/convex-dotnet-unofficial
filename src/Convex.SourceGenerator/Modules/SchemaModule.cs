...
public class SchemaModule : IGenerationModule
{
    ...
    private string EmitTableClass(TableDefinition table, GeneratorOptions options)
    {
        ...
        sb.EmitUsings("System.Text.Json.Serialization", "System.Collections.Generic", "Convex.Client.Infrastructure.Serialization");
        ...
        GeneratorOptions options)
    {
        ...
        if (isTable && tableName != null)
        {
            ...
            sb.AppendLine("public DateTimeOffset CreationTime { get; init; }");
            sb.AppendLine();
        }
        ...
        GeneratorOptions options)
    {
        ...
        if (isTimestamp)
        {
            actualType = actualType == "double?" ? "DateTimeOffset?" : "DateTimeOffset";
        }
        ...
        if (isTimestamp)
        {
            var converterType = actualType == "DateTimeOffset?"
