...
public class ConvexClientTimeoutTests
{
    [Fact]
    public void Timeout_WithZeroValue_ThrowsArgumentOutOfRangeException()
    {
        // Arrange
        using var client = new ConvexClientBuilder()
            .UseDeployment("https://test.convex.cloud")
            .Build();
    ...
    [Fact]
    public void Timeout_WithNegativeValue_ThrowsArgumentOutOfRangeException()
    {
        // Arrange
        using var client = new ConvexClientBuilder()
            .UseDeployment("https://test.convex.cloud")
    ...
    [Fact]
    public void Timeout_ExceedingMaximum_ThrowsArgumentOutOfRangeException()
    {
        // Arrange
        using var client = new ConvexClientBuilder()
            .UseDeployment("https://test.convex.cloud")
        ...
        // Act & Assert
        var ex = Assert.Throws<ArgumentOutOfRangeException>(() =>
            client.Timeout = TimeSpan.FromHours(25));
        Assert.Contains("24 hours", ex.Message);
    }

    [Fact]
    public void Timeout_WithValidValue_SetsTimeout()
    {
        // Arrange
        using var client = new ConvexClientBuilder()
            .UseDeployment("https://test.convex.cloud")
    ...
    [Fact]
    public void Timeout_AtMaximumBoundary_SetsTimeout()
    {
        // Arrange
        using var client = new ConvexClientBuilder()
            .UseDeployment("https://test.convex.cloud")
        ...
        // Assert
        Assert.Equal(TimeSpan.FromHours(24), client.Timeout);
    }
}
